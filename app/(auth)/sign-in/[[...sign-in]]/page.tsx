        ...
        <div className="relative z-20 mt-auto space-y-8">
          <div className="space-y-6">
            <div className="group flex items-start gap-4 p-4 rounded-xl transition-colors hover:bg-white/5">
              ...
              <div>
                ...
                <p className="text-sm text-zinc-400 leading-relaxed">
                  Stay updated on your daily, weekly, or monthly accruals
            ...
            <div className="group flex items-start gap-4 p-4 rounded-xl transition-colors hover:bg-white/5">
              ...
              <div>
                <h4 className="font-semibold text-white">Financial Clarity</h4>
                <p className="text-sm text-zinc-400 leading-relaxed">
                  Real-time visualization of what you owe and what you&apos;re
                  owed, all in one dashboard.
                </p>
              </div>
            </div>
            ...
            <div className="group flex items-start gap-4 p-4 rounded-xl transition-colors hover:bg-white/5">
              ...
              <div>
                ...
                <p className="text-sm text-zinc-400 leading-relaxed">
                  Keep your personal expenses separate from your lending pool
          ...
          <div className="pt-8 border-t border-white/10">
            <p className="text-xs text-zinc-500 uppercase tracking-widest font-medium">
              Simplified lending for everyone.
            </p>
          </div>
        </div>
      </div>
